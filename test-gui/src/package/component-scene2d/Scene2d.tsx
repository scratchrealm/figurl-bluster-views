...
import { AffineTransform, applyAffineTransformInv } from "./AffineTransform";
...
const Scene2d: FunctionComponent<Props> = ({width, height, objects, onClickObject, onDragObject, onSelectObjects, onSelectRect, onClick, affineTransform}) => {
	...
	const paint = useCallback((ctxt: CanvasRenderingContext2D, props: any) => {
        ...
        objects.sort((o1, o2) => {if (o1.selected && !o2.selected) return 1; else if (!o1.selected && o2.selected) return -1; else return 0;}).forEach(object => {
			paintObject(object)
		})
		ctxt.restore()
